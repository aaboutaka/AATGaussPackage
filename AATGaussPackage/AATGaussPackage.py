...
parser.add_argument("-xmn", "--xmin", nargs='?', type=float, default=0.0,
                    help="Set x axis initial  point. The default value is 0.0")
parser.add_argument("-xmx", "--xmax", nargs='?', type=float,
